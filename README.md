...
- `DAILY_BACKUP_CRON` - The cron schedule to run the daily backups on. Example: `0 0 * * 1`

- `WEEKLY_BACKUP_CRON` - The cron schedule to run the weekly backups on. Example: `0 0,12 * * *`
